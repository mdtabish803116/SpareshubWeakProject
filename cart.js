var cartList= JSON.parse(localStorage.getItem("cartList"))|| [];
    ...
    cartButtonNav = document.getElementById("navCart");
    cartButtonMob = document.getElementById("mobCart");
...
var cartBox = document.createElement("div");
   ...
   cartButtonNav.addEventListener("click" , function(){
      cartBox.innerText = "";
          ...
          removeBtn.addEventListener("click", function(){
              ...
              localStorage.setItem("cartList" , JSON.stringify(cartList));
               //  displayCart()
                 ...
                 document.getElementById("navCart").click();
               // window.location.reload();
  ...
  cartButtonNav.append(cartBox);
   ...
   cartButtonMob.addEventListener("click" , function(){
    cartBox.innerText = "";
